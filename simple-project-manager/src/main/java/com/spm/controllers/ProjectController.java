...
import com.spm.enums.OrderDirection;
import com.spm.enums.SortField;
...
public class ProjectController {
   ...
   /// }
    ...
    public ResponseEntity<List<ProjectBudgetSummaryDTO>> getBudgetSummaries(
            ...
            @RequestParam(defaultValue = "id") SortField sortBy, // Sorting field
            @RequestParam(defaultValue = "asc") OrderDirection order, // Sorting order
        ...
        List<ProjectBudgetSummaryDTO> budgetSummaries = projectService.getFilteredBudgetSummaries(
                exceededBudget, sortBy.getField(), order.getDirection(), page, size
        );
